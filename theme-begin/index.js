...
// Theme API.
module.exports = (themeConfigOpt, ctx) => {
  const {
    options: { source: sourceDir, themeConfig },
    siteData: siteConfig,
  } = ctx
...
//     plugins: [
//       ['@vuepress/active-header-links', themeConfigOpt.activeHeaderLinks],
...
//         {
//           type: 'center',
//           before: (info) => `<div class="center-@vuepress/container">`,
//           after: () => '</div>',
//         },
//       ],
// 
